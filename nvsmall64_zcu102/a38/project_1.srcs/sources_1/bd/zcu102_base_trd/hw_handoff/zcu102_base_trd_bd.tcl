...
################################################################
# This is a generated script based on design: zcu102_base_trd
#
...
# source zcu102_base_trd_script.tcl
...
set design_name zcu102_base_trd
...
proc create_hier_cell_tpg_input { parentCell nameHier } {
  ...
  create_bd_pin -dir I clk_in_1
  create_bd_pin -dir I clk_in_2
  ...
  # Create instance: clk_mux_gpio, and set properties
  set clk_mux_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 clk_mux_gpio ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {95} \
  ...
  connect_bd_intf_net -intf_net axi_fifo_0_M_AXI [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_data_fifo_0/M_AXI]
  ...
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins clk_mux_gpio/Din] [get_bd_pins frmbuf_wr_rst_gpio/Din] [get_bd_pins tpg_rst_gpio/Din]
  connect_bd_net -net clk_50mhz [get_bd_pins s_axi_aclk] [get_bd_pins v_tc_1/s_axi_aclk]
  connect_bd_net -net clk_in_1_1 [get_bd_pins clk_in_1] [get_bd_pins clock_mux_0/clk_in_1]
  connect_bd_net -net clk_in_2_1 [get_bd_pins clk_in_2] [get_bd_pins clock_mux_0/clk_in_2]
  ...
  connect_bd_net -net frmbuf_wr_rst_gpio_Dout [get_bd_pins axi_data_fifo_0/aresetn] [get_bd_pins frmbuf_wr_rst_gpio/Dout] [get_bd_pins v_frmbuf_wr_0/ap_rst_n]
  ...
  connect_bd_net -net tpg_rst_gpio_Dout [get_bd_pins tpg_rst_gpio/Dout] [get_bd_pins v_tpg_1/ap_rst_n]
  connect_bd_net -net v_frmbuf_wr_0_interrupt [get_bd_pins s2mm_introut] [get_bd_pins v_frmbuf_wr_0/interrupt]
  connect_bd_net -net v_mix_rst_gpio_Dout [get_bd_pins clk_mux_gpio/Dout] [get_bd_pins clock_mux_0/sel]
...
proc create_hier_cell_hdmi_input { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_data_fifo_m_axi [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_data_fifo_0/M_AXI]
  connect_bd_intf_net -intf_net v_frmbuf_wr_0_m_axi_mm_video [get_bd_intf_pins axi_data_fifo_0/S_AXI] [get_bd_intf_pins v_frmbuf_wr_0/m_axi_mm_video]
  ...
  connect_bd_net -net m_axi_s2mm_aclk_1 [get_bd_pins m_axi_s2mm_aclk] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins v_hdmi_rx_ss_0/s_axis_video_aclk] [get_bd_pins v_proc_ss_scaler/aclk_axis] [get_bd_pins v_proc_ss_scaler/aclk_ctrl]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT6_JITTER {129.940} \
   CONFIG.CLKOUT6_PHASE_ERROR {154.695} \
...
96: CSI FB WR
104: Sensor IIC
105: Video Mixer" [get_bd_cells /interrupts0]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {1} \
 ] $interrupts0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M03_AXI [get_bd_intf_pins axi_interconnect_hpm0/M03_AXI] [get_bd_intf_pins hdmi_ctl_iic/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M06_AXI [get_bd_intf_pins axi_interconnect_hpm0/M06_AXI] [get_bd_intf_pins vid_phy_controller_0/vid_phy_axi4lite]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M08_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins axi_interconnect_hpm0/M08_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M06_AXI [get_bd_intf_pins axi_interconnect_hpm1/M06_AXI] [get_bd_intf_pins tpg_input/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M08_AXI [get_bd_intf_pins axi_interconnect_hpm1/M08_AXI] [get_bd_intf_pins hdmi_output/s_axi_CTRL1]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M09_AXI [get_bd_intf_pins axi_interconnect_hpm1/M09_AXI] [get_bd_intf_pins hdmi_input/s_axi_CTRL]
  connect_bd_intf_net -intf_net ctrl_1 [get_bd_intf_pins axi_interconnect_hpm1/M00_AXI] [get_bd_intf_pins tpg_input/ctrl]
  ...
  connect_bd_intf_net -intf_net mipi_csi2_rx_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_hp1/S02_AXI] [get_bd_intf_pins mipi_csi2_rx/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net nv_small_64_v07_0_m_dbb [get_bd_intf_pins nv_small_64_v07_0/m_dbb] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  ...
  connect_bd_net -net clk_150mhz [get_bd_pins axi_interconnect_hp0/ACLK] [get_bd_pins axi_interconnect_hp0/M00_ACLK] [get_bd_pins axi_interconnect_hp0/S00_ACLK] [get_bd_pins axi_interconnect_hp0/S01_ACLK] [get_bd_pins axi_interconnect_hp0/S02_ACLK] [get_bd_pins axi_interconnect_hp0/S03_ACLK] [get_bd_pins axi_interconnect_hp1/ACLK] [get_bd_pins axi_interconnect_hp1/M00_ACLK] [get_bd_pins axi_interconnect_hp1/S00_ACLK] [get_bd_pins axi_interconnect_hp1/S01_ACLK] [get_bd_pins axi_interconnect_hp1/S02_ACLK] [get_bd_pins axi_interconnect_hpm1/ACLK] [get_bd_pins axi_interconnect_hpm1/M00_ACLK] [get_bd_pins axi_interconnect_hpm1/M01_ACLK] [get_bd_pins axi_interconnect_hpm1/M02_ACLK] [get_bd_pins axi_interconnect_hpm1/M03_ACLK] [get_bd_pins axi_interconnect_hpm1/M04_ACLK] [get_bd_pins axi_interconnect_hpm1/M05_ACLK] [get_bd_pins axi_interconnect_hpm1/M06_ACLK] [get_bd_pins axi_interconnect_hpm1/M07_ACLK] [get_bd_pins axi_interconnect_hpm1/M08_ACLK] [get_bd_pins axi_interconnect_hpm1/M09_ACLK] [get_bd_pins axi_interconnect_hpm1/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins hdmi_input/m_axi_s2mm_aclk] [get_bd_pins hdmi_output/ap_clk] [get_bd_pins mipi_csi2_rx/m_axi_s2mm_aclk] [get_bd_pins tpg_input/m_axi_s2mm_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net clk_50mhz [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_hpm0/ACLK] [get_bd_pins axi_interconnect_hpm0/M00_ACLK] [get_bd_pins axi_interconnect_hpm0/M01_ACLK] [get_bd_pins axi_interconnect_hpm0/M02_ACLK] [get_bd_pins axi_interconnect_hpm0/M03_ACLK] [get_bd_pins axi_interconnect_hpm0/M04_ACLK] [get_bd_pins axi_interconnect_hpm0/M05_ACLK] [get_bd_pins axi_interconnect_hpm0/M06_ACLK] [get_bd_pins axi_interconnect_hpm0/M07_ACLK] [get_bd_pins axi_interconnect_hpm0/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins hdmi_ctl_iic/s_axi_aclk] [get_bd_pins hdmi_input/clk_50mhz] [get_bd_pins hdmi_output/s_axis_audio_aclk] [get_bd_pins mipi_csi2_rx/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins sensor_iic/s_axi_aclk] [get_bd_pins tpg_input/s_axi_aclk] [get_bd_pins vid_phy_controller_0/drpclk] [get_bd_pins vid_phy_controller_0/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller_0/vid_phy_sb_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_1_clk_out5 [get_bd_pins clk_wiz_1/clk_out5] [get_bd_pins mipi_csi2_rx/dphy_clk_200M]
  connect_bd_net -net clk_wiz_1_clk_out6 [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_interconnect_hpm0/M08_ACLK] [get_bd_pins clk_wiz_1/clk_out6] [get_bd_pins nv_small_64_v07_0/dla_core_clk] [get_bd_pins nv_small_64_v07_0/dla_csb_clk] [get_bd_pins nv_small_64_v07_0/pclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_net -net interrupts0_dout [get_bd_pins interrupts0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net interrupts1_dout [get_bd_pins interrupts1/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  ...
  connect_bd_net -net nv_small_64_v07_0_dla_intr [get_bd_pins nv_small_64_v07_0/dla_intr] [get_bd_pins platform_interrupts/In10]
  ...
  connect_bd_net -net platform_interrupts_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins platform_interrupts/dout]
  connect_bd_net -net proc_sys_reset_clk50_interconnect_aresetn [get_bd_pins axi_interconnect_hp0/ARESETN] [get_bd_pins axi_interconnect_hp1/ARESETN] [get_bd_pins axi_interconnect_hpm0/ARESETN] [get_bd_pins axi_interconnect_hpm1/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_clk50_peripheral_aresetn [get_bd_ports si5324_rst_out] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_hp0/M00_ARESETN] [get_bd_pins axi_interconnect_hp0/S00_ARESETN] [get_bd_pins axi_interconnect_hp0/S01_ARESETN] [get_bd_pins axi_interconnect_hp0/S02_ARESETN] [get_bd_pins axi_interconnect_hp0/S03_ARESETN] [get_bd_pins axi_interconnect_hp1/M00_ARESETN] [get_bd_pins axi_interconnect_hp1/S00_ARESETN] [get_bd_pins axi_interconnect_hp1/S01_ARESETN] [get_bd_pins axi_interconnect_hp1/S02_ARESETN] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M01_ARESETN] [get_bd_pins axi_interconnect_hpm0/M02_ARESETN] [get_bd_pins axi_interconnect_hpm0/M03_ARESETN] [get_bd_pins axi_interconnect_hpm0/M04_ARESETN] [get_bd_pins axi_interconnect_hpm0/M05_ARESETN] [get_bd_pins axi_interconnect_hpm0/M06_ARESETN] [get_bd_pins axi_interconnect_hpm0/M07_ARESETN] [get_bd_pins axi_interconnect_hpm0/M08_ARESETN] [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M01_ARESETN] [get_bd_pins axi_interconnect_hpm1/M02_ARESETN] [get_bd_pins axi_interconnect_hpm1/M03_ARESETN] [get_bd_pins axi_interconnect_hpm1/M04_ARESETN] [get_bd_pins axi_interconnect_hpm1/M05_ARESETN] [get_bd_pins axi_interconnect_hpm1/M06_ARESETN] [get_bd_pins axi_interconnect_hpm1/M07_ARESETN] [get_bd_pins axi_interconnect_hpm1/M08_ARESETN] [get_bd_pins axi_interconnect_hpm1/M09_ARESETN] [get_bd_pins axi_interconnect_hpm1/S00_ARESETN] [get_bd_pins hdmi_ctl_iic/s_axi_aresetn] [get_bd_pins hdmi_input/s_axi_cpu_aresetn] [get_bd_pins hdmi_input/s_axis_video_aresetn] [get_bd_pins hdmi_output/s_axi_cpu_aresetn] [get_bd_pins hdmi_output/s_axis_video_aresetn] [get_bd_pins mipi_csi2_rx/axi_resetn] [get_bd_pins mipi_csi2_rx/video_aresetn] [get_bd_pins nv_small_64_v07_0/dla_reset_rstn] [get_bd_pins nv_small_64_v07_0/prstn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sensor_iic/s_axi_aresetn] [get_bd_pins vid_phy_controller_0/vid_phy_axi4lite_aresetn] [get_bd_pins vid_phy_controller_0/vid_phy_sb_aresetn]
  ...
  connect_bd_net -net tpg_input_s2mm_introut [get_bd_pins platform_interrupts/In0] [get_bd_pins tpg_input/s2mm_introut]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins dru_clk/IBUF_OUT] [get_bd_pins vid_phy_controller_0/gtsouthrefclk0_in]
  connect_bd_net -net util_ds_buf_1_BUFG_GT_O [get_bd_pins dru_clk/BUFG_GT_O] [get_bd_pins vid_phy_controller_0/gtsouthrefclk0_odiv2_in]
  connect_bd_net -net v_hdmi_tx_ss_0_irq [get_bd_pins hdmi_output/irq] [get_bd_pins platform_interrupts/In4]
  connect_bd_net -net vcc_dout [get_bd_ports sensor_gpio_flash] [get_bd_ports sensor_gpio_spi_cs_n] [get_bd_pins mipi_csi2_rx/dout1]
  ...
  connect_bd_net -net vid_phy_controller_0_tx_video_clk1 [get_bd_pins hdmi_output/video_clk] [get_bd_pins tpg_input/clk_in_2] [get_bd_pins vid_phy_controller_0/tx_video_clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins nv_small_64_v07_0/global_clk_ovr_on] [get_bd_pins nv_small_64_v07_0/test_mode] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins nv_small_64_v07_0/direct_reset_] [get_bd_pins nv_small_64_v07_0/tmc2slcg_disable_clock_gating] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_a_pd] [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_c_pd] [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_ma_pd] [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_mb_pd] [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_o_pd] [get_bd_pins nv_small_64_v07_0/nvdla_pwrbus_ram_p_pd] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_video_ref_clk [get_bd_pins tpg_input/clk_in_1] [get_bd_pins zynq_ultra_ps_e_0/dp_video_ref_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins hdmi_input/Din] [get_bd_pins hdmi_output/Din] [get_bd_pins mipi_csi2_rx/Din] [get_bd_pins tpg_input/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x000800000000 -offset 0x000800000000 [get_bd_addr_spaces nv_small_64_v07_0/m_dbb] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] SEG_zynq_ultra_ps_e_0_HPC0_DDR_HIGH
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces nv_small_64_v07_0/m_dbb] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces nv_small_64_v07_0/m_dbb] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces nv_small_64_v07_0/m_dbb] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_ctl_iic/S_AXI/Reg] SEG_hdmi_ctl_iic_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/mipi_csi2_rx_subsystem_0/csirxss_s_axi/Reg] SEG_mipi_csi2_rx_subsystem_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA00A0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sensor_iic/S_AXI/Reg] SEG_sensor_iic_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_demosaic_0/s_axi_CTRL/Reg] SEG_v_demosaic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0050000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tpg_input/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0xB0070000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg2
  create_bd_addr_seg -range 0x00010000 -offset 0xB0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_gamma_lut_0/s_axi_CTRL/Reg] SEG_v_gamma_lut_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA1000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_hdmi_rx_ss_0/S_AXI_CPU_IN/Reg] SEG_v_hdmi_rx_ss_0_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0xA0080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_output/v_hdmi_tx_ss_0/S_AXI_CPU_IN/Reg] SEG_v_hdmi_tx_ss_0_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xB00C0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_output/v_mix_0/s_axi_CTRL/Reg] SEG_v_mix_0_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xB0080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_proc_ss_scaler/s_axi_ctrl/Reg] SEG_v_proc_ss_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx/v_proc_ss_csc/s_axi_ctrl/Reg] SEG_v_proc_ss_1_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xB0100000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hdmi_input/v_proc_ss_scaler/s_axi_ctrl/Reg] SEG_v_proc_ss_scaler_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xB0030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tpg_input/v_tpg_1/s_axi_CTRL/Reg] SEG_v_tpg_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs vid_phy_controller_0/vid_phy_axi4lite/Reg] SEG_vid_phy_controller_0_Reg
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces hdmi_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  ...
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video1] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video2] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video3] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces hdmi_output/v_mix_0/Data_m_axi_mm_video4] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  ...
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces mipi_csi2_rx/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces tpg_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces tpg_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces tpg_input/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  ...
  set_property PFM_NAME {vendor:lib:zcu102:1.0} [get_files [current_bd_design].bd]
